package com.caicai.spark.core.project.acc

import com.caicai.spark.core.project.bean.UserVisitAction
...
class CategoryAcc1 extends AccumulatorV2[UserVisitAction, Map[(String, String), Long]] {
    ...
    override def add(v: UserVisitAction): Unit = {
        ...
        v match {
            ...
            // 其他非正常情况, 做任何处理
            case _ => throw new UnsupportedOperationException("Wrong Information")
        }
    }
