package com.caicai.streaming.project.app

import com.caicai.streaming.project.bean.AdsInfo
import com.caicai.streaming.project.util.RedisUtil
...
object AreaTopApp extends App {
    override def doSomething(adsInfoStream: DStream[AdsInfo]): Unit = {
        ...
        import com.caicai.streaming.project.util.RealUtil._
        result.saveToRedis
    }
}
