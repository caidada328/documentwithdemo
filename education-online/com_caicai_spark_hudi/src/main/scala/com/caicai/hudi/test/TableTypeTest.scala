package com.caicai.hudi.test

import com.caicai.bean.DwsMember
import com.caicai.hudi.util.ParseJsonData
...
//    updateData(sparkSession)
  ...
  def generateData(sparkSession: SparkSession) = {
    ...
    val df = sparkSession.read.text("/user/caicai/ods/member.log")
    ...
    df.write.format("org.apache.hudi")
      ...
      .save("/user/caicai/hudi/hudimembertest1")
