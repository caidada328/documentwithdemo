package com.caicai.qzpoint.streaming

import java.lang
import java.sql.{Connection, ResultSet}
import java.text.NumberFormat

import com.caicai.qzpoint.util.{DataSourceUtil, ParseJsonData, QueryCallback, SqlProxy}
...
/**
  * 页面转换率实时统计
  *
  * nohup spark-submit  --master yarn --deploy-mode client --driver-memory 1g --num-executors 5 --executor-cores 2 --executor-memory 2g --class com.caicai.qzpoint.streaming.PageStreaming  --queue spark com_caicai_sparkstreaming-1.0-SNAPSHOT-jar-with-dependencies.jar >1.txt>&1 &
  */
