...
import com.caicai.education.model._
...
//flink run -m yarn-cluster -ynm dimetl -p 12 -ys 4 -yjm 1024 -ytm 2048m -d -c com.caicai.education.etl.DImJoinData  -yqu flink ./education-flink-online-1.0-SNAPSHOT-jar-with-dependencies.jar --group.id test --bootstrap.servers hadoop101:9092,hadoop102:9092,hadoop103:9092
...
object DImJoinData {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //    resultStream.print()
    val result = AsyncDataStream.orderedWait(resultStream, new DimHbaseAsyncFunction, 10l, java.util.concurrent.TimeUnit.MINUTES, 10)
    //    result.print()
    env.execute()
  }
