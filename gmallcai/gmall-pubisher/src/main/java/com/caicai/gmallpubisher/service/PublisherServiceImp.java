package com.caicai.gmallpubisher.service;

import com.caicai.gmall.common.Constant;
import com.caicai.gmall.common.ESUtil;
import com.caicai.gmallpubisher.mapper.DauMapper;
import com.caicai.gmallpubisher.mapper.OrderInfoMapper;
...
public class PublisherServiceImp implements PublisherService {
   ...
   DauMapper dauMapper;
    ...
    public Map<String, Object> getSaleDetailAndAggGroupByField(String date,
        ...
        // 2. 查询数据(聚合)
        String dsl = String.valueOf(DSLs.getSaleDetailDSL(date, keyWord, startPage, sizePerPage, aggField, aggCount));
