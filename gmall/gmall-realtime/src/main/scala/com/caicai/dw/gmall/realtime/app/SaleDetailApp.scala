package com.caicai.dw.gmall.realtime.app
...
import com.caicai.dw.gmall.common.Constant
import com.caicai.dw.gmall.realtime.bean.{OrderDetail, OrderInfo, SaleDetail, UserInfo}
import com.caicai.dw.gmall.realtime.util.{EsUtil, MyKafkaUtil, RedisUtil}
